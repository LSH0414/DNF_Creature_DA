...
<h3>상위그룹 크리쳐 통계</h3>
  ...
  <img src='https://github.com/LSH0414/DNF_Creature_DA/assets/119479455/62cb13c7-c9d7-4104-9203-53d81c54dfe8'>
   ...
   선계 패키지 종료된 시점에서 에를리히 보유 숫자가 크게 늘어난 모습을 확인할 수 있음. 이는 신규 종결 파츠 등장에 유저들의 저항력이 강하지 않다는 것을 의미함. 이전 종결 크리쳐인 순백나비와 페리아 수를 합쳐도 신규 크리쳐 수가 높다는 점에서 이번 신규 상품 출시에 따른 유저들의 반응은 긍정적으로 해석할 수 있음.
...
아라드 패스 S1에서는, 30만 캐릭터까지는 종결 크리쳐로 더 많이 넘어간 모습을 확인할 수 있음.
  ...
  S1과 비교하여 종결 크리쳐로 변경한 유저들이 늘어난 것을 한 눈에 확인할 수 있음. 눈에 띄는 점은 두 가지인데, 첫번째는 30만 유저까지 종결크리쳐가 더 많았다면 S2시작 이후 36만 선으로 내려온 것. 두번째는 전체 비율이 이전에는 확연하게 차이가 나는 것을 확인할 수 있었는데 신규 크리쳐의 비율이 전체로 가더라도 그 감소폭이 크지 않다는 것이 의미있음. 이는 유저들이 지속적으로 신규 크리처를 구매하고 있고 새로운 패스로 인해 공급이 늘었기 때문으로 추정.
</ul>
  ...
  선계 패키지 판매가 종료된 시점에서는 모든 구간 신규 크리쳐 비율이 가장 높음. 전체의 40% 넘는 유저가 신규 종결 크리쳐로 변화한 모습으로 이는 매우 긍정적인 지표로 볼 수 있음. S1 패스와 비교해보면 약 30만 개의 캐릭터가 종결 크리쳐로 이동한 결과임. 무엇보다 전체 그룹에서도 신규 종결 크리쳐의 수가 의미있을 정도로 차이가 벌어졌다는게 긍정적인 지표. 이를 통해 신규 종결 파츠 등장에 대한 저항력이 크지 않음을 확인할 수 있음.

다만 S1 -> S2 -> 선계 패키지 종료 순으로 변화만큼 앞으로도 변화할지에 대해서는 부정적. 그 이유는 에를리히, 슈므에 대한 공급처가 이제는 아라드 패스 뿐이며, 해당 지표에는 무제한 상품으로 바꾸기 이전의 기간제 상품도 포함되있기 때문에 신규 유저 유입이 아니라면 증가하기 어려움.
  ...
  특이하게 나타난 데이터는 이전 종결 크리쳐였던 순백나비의 본캐 제외시 감소율임. 이러한 결과는 다 캐릭터 육성 유저중 본캐(명성치가 가장 높은 캐릭터)에 이전 종결 크리쳐를 장착한 경우 다른 캐릭터에는 신규 종결 혹은 가성비 크리쳐를 장착하고 있는 비율이 많다는 것을 의미한다. 그런데 본캐 제외시 감소율이 신규 종결 크리쳐도 높게 나타난 것으로 보아 가성비 크리쳐를 장착하고 있다고 해석할 수 있음. 따라서 이러한 그룹군은 단일 캐릭터만 키우는 유저와 비슷한 성향을 가진 유저라 볼 수 있음. 그렇기에 패스 상품 구매 상승을 위한 상품 분석시 고려해야할 하나의 그룹군임.
  </ul> 
  ...
  - 월 초(1일)에는 기존 거래 패턴과 상관없이 크게 상승.
  - 10일, 25일에 거래량이 상승한 것은 월급날로 유저의 대부분이 직장인으로 유추할 수 있음. 다만, 25일의 경우 패키지 종료 시점이라는 점에서 증가했을 수 있음.
...
크리쳐 스킨 총 집계 결과
<ul>
<li>총 캐릭터 수 : 516,896(크리쳐 스킨 장착 유저만 집계)</li>
<li>크리쳐 스킨 장착 수 : 110,302</li>
<li>상위 30개 항목 지분율 : 54,885(약 50%)</li>
</ul>

<br/>
이를 통해서 알 수 있는 것은 크리쳐 자체가 스팩업을 위한 수단으로 주로 사용될뿐 외형적인 부분에 대해서는 좀 더 자세한 분석이 필요하다는 생각됨. 물론 기본 크리쳐 외형이 마음에 들어서 사용하지 않을 수 있지만, 그럼에도 스킨 크리쳐를 착용하고 있는 비율이 약 20%에 불과했다는 점은 조금 아쉬운 부분임. 스킨 크리쳐의 경우 상품 자체는 이벤트를 통해 지속적인 공급이 있었지만 그 수요가 받쳐주지 못하고 있다는 것으로 해석할 수 있음. 또한, 스킨 크리쳐를 이용하고 있는 유저 중 절반 이상이 800개(장착한 스킨 크리쳐 기준)가 넘는 크리쳐 스킨이 있음에도 소수에 몰려있다는 점을 확인할 수 있음. 이벤트를 통해 지속적인 공급이 있음에도 유저들이 둔감하게 반응한다는 점에서 스킨 크리쳐 시스템에 대해 면밀한 분석이 필요하다 생각됨.
...
<ul>
  <li>
    신규 종결 크리쳐 출시 이후 관련 패키지 판매 종료까지 유저들의 변화를 봤을때, 상위 60만개의 캐릭터를 기준으로 신규 크리쳐 보유수가 가장 높음은, 새로운 엔드 상품 출시에 따른 유저들의 저항감이 강하지 않다는 것을 의미함.
  </li>
  <br>
  <li>
    하지만 1개 캐릭터만 육성하는 유저의 경우, 신규 크리처 수량이 3번째에 위치해 신규 크리처 출시에도 불구하고, 오히려 가성비 크리처에 대한수요가 더 높게 나타남. 이는 모든 유저가 신규 종결 크리처 구매에 열정적이지 않음을 시사하며, 단일 캐릭터 육성 유저 그룹은 성능보다는 가격을 중시하는 것으로 해석할 수 있어, 스팩에 영향을 주는 상품에 둔감함하다는 것으로 해석할 수 있음.
  </li>
  <br>
  <li>
  ...
  <br>
  <li>
    다중 캐릭터를 육성 유저들이 신규 크리처 이동이 활발했던 이유는 패스를 통한 공급이 컸다고 생각됨. 이러한 점에서 단일 캐릭터를 육성하는 유저는 패스까지 구매가 이뤄지지 않고 있는 것인가를 확인할 필요가 있어 보임. 확신 할 수 없는 이유는 패스 최종 보상으로 크리쳐를 받지 않았을 수 있기 때문임.
  </li>
<br>
  <li>
    단일 캐릭터를 육성하는 유저의 경우 약 6만으로 전체 모험단(148,631)의 절반에 가까운 숫자로 포기하기에는 큰 비중임. 따라서 이 단일 캐릭터 육성 유저가 패스 구매에 대한 추가 분석이 필요하다 생각됨.
  </li>
  <br>
  <li>
    추가로 크리쳐 스킨의 경우 게임사에서 지속적인 공급이 있지만 유저가 활용하고 있다고 보기 어려운 지표로 나타남. 이에 대해서도 좀 더 자세한 분석을 할 필요성이 있음.
  </li>
</ul>
</ul>
</br>
